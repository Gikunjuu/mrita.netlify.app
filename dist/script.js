...
$(document).ready(function () {
  ...
  $(document).on("click", ".closeme", function (event) {
    ...
    // setTimeout(() => $("#calendar-modal").hide(), 2000);
  });
  // console.log($(".closeme"));

  // $("#close_pop").on("mousedown", function (e) {
  //  e.stopPropagation();
  // alert("test click");
  ...
  // $("body").on("click", ".fc-list-item", function (e) {
  //   alert("row");
  // });
...
//       .append(
//         '<input type="button" name="button" value="button"  class="testttt" style="position:absolute; cursor:pointer; top:15px; right:15px; z-index:999;"/>'
//       );
...
//     e.stopPropagation();
//     window.alert("clickkkkkkkkkkkkkkkk");
...
$(function () {
  ...
  select.on("change", function (e) {
    // window.location.host + window.location.pathname + "date=upcoming";

    // alert(nice_sel.find(".option.selected").text());
    // alert(nice_sel.find(".option.selected").data("value"));
